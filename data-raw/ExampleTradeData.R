...
ExampleTradeData <- ReadTradeData[ReadTradeData$i %in% c(4, 710) & nchar(as.character(ReadTradeData$k)) == 6, ][c(FALSE, TRUE, FALSE, FALSE), ][c(FALSE, TRUE, FALSE, FALSE), ][c(FALSE, TRUE, FALSE, FALSE), ][c(FALSE, TRUE, FALSE, FALSE), ]
